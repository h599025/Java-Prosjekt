...
import no.hvl.dat100.prosjekt.kontroll.NordSpiller;
...
public class Kontroll {
	...
	public boolean harVinner() {
		...
		System.out.println("Nord har vunnet " + nordVinner + " ganger");
		System.out.println("Syd har vunnet " + sydVinner + " ganger");
